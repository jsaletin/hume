...
%  Montage Generated from File: 11F.EDF
%  Montage Generated on Date: 27-Jan-2015
...
CurrMontage.electrodes = flipud({'C3-A2';'O2-A1';'ROC-A1';'LOC-A2';'Chin EMG1-Chin';'C4-A1';'O1-A2';});
% channels to plot negative up
CurrMontage.negChans = {'C3-A2';'O2-A1';'ROC-A1';'LOC-A2';'Chin EMG1-Chin';'C4-A1';'O1-A2';};
