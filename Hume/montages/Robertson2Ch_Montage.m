...
%  Montage Generated from File: S32_N2.edf
...
handles.electrodes = flipud({'C4-A1';'O2-A1';});
...
handles.scaleChans = {'C4-A1' 'O2-A1' };
% voltage to place scales
handles.bigGridMat{1,1} = 'C4-A1';
