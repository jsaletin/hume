...
%  Montage Generated from File: 217006_BSLN_Scoring
%  Montage Generated on Date: 27-Nov-2019
...
CurrMontage.electrodes = flipud({'C3-A2';'O2-A1';'ROC-A1';'LOC-A2';'EMG1-EMG2';'C4-A1';'O1-A2';});
% channels to plot negative up
CurrMontage.negChans = {'C3-A2';'O2-A1';'ROC-A1';'LOC-A2';'EMG1-EMG2';'C4-A1';'O1-A2';};
