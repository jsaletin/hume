...
numEvents = length(eventToPlot);
eventAdjust = numEvents - 1;

figure('Position', [100, 700, 550, 160+(16*eventAdjust)],'visible','off');
...
plot([onT, onT], [-1-eventAdjust, 9], 'r', 'LineWidth', 1);
hold;
plot([offT, offT], [-1-eventAdjust, 9], 'g', 'LineWidth', 1);
...
stageColors = [100 100 100; 102 255 255; 0 158 225; 102 102 255; 128 0 255; 255 0 0; 200 200 200; 0 0 0]./255;
%stageNames = {'wake'; 'stage1'; 'stage2'; 'stage3'; 'stage4'; 'rem'; 'mt'};
...
set(gca, 'Xlim', stageData.stageTime([1, end]),'Ylim', [-1-eventAdjust, 9],'YTick', [-.5-(eventAdjust):1:-.5 1:8],'YTickLabel', [flipud(eFields);{'ANOM'; 'REM'; 'Stage4'; 'Stage3'; 'Stage2'; 'Stage1'; 'WAKE'; 'MT'; ''}]);
set(gca,'TickDir','out');
set(gca,'box','off')
...
eventAdjust = numEvents - 1;
    ...
    figure('Position', [100, 700, 550, 144+(16*eventAdjust)],'visible','off');
...
plot([onT, onT], [-1-eventAdjust, 8], 'r', 'LineWidth', 1);
hold;
plot([offT, offT], [-1-eventAdjust, 8], 'g', 'LineWidth', 1);
...
set(gca, 'Xlim', stageData.stageTime([1, end]),'Ylim', [-1-eventAdjust, 8],'YTick', [-.5-(eventAdjust):1:-.5 1:7],'YTickLabel', [flipud(eFields);{'ANOM'; 'REM'; 'SW'; 'Stage2'; 'Stage1'; 'Wake'; 'MT'; ''}]);
set(gca,'TickDir','out');
set(gca,'box','off')
