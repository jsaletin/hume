function stageData = EGI_LoadNotes(stageData, notesFile, recStart, outname)
%stageData = EGI_LoadNotes(stageData, notesFile)
%
%   Import EGI NetStation 4 Recording Notes including Lights Off and Lights On
