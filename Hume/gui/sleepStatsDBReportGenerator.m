...
guiDB = {'TDT_ep' 'TDT.epochs AS TDTeps'
    'TDT_min'	'TDT.Minutes AS TDTmin'
    'TDT_TDT'	'ROUND(TDT.TDTper*100, 1) AS TDT_TDTper'
    'TDT_SPT'	'ROUND(TDT.SPTper*100, 1) AS TDT_SPTper'
    'TDT_TST'	'ROUND(TDT.TSTper*100, 1) AS TDT_TSTper'
    'SPT_ep'    'SPT.epochs AS SPTeps'
    'SPT_min'   'SPT.Minutes AS SPTmin'
    'SPT_TDT'	'ROUND(SPT.TDTper*100, 1) AS SPT_TDTper'
    'SPT_SPT'	'ROUND(SPT.SPTper*100, 1) AS SPT_SPTper'
    'SPT_TST'	'ROUND(SPT.TSTper*100, 1) AS SPT_TSTper'
    'TST_ep'    'TST.epochs AS TSTeps'
    'TST_min'   'TST.Minutes AS TSTmin'
    'TST_TDT'   'ROUND(TST.TDTper*100, 1) AS TST_TDTper'
    'TST_SPT'   'ROUND(TST.SPTper*100, 1) AS TST_SPTper'
    'TST_TST'   'ROUND(TST.TSTper*100, 1) AS TST_TSTper'
    'SBSO_ep'   'SBSO.epochs AS SBSOeps'
    'SBSO_min'  'SBSO.Minutes AS SBSOmin'
    'SBSO_TDT'  'ROUND(SBSO.TDTper*100, 1) AS SBSO_TDTper'
    'SBSO_SPT'  'ROUND(SBSO.SPTper*100, 1) AS SBSO_SPTper'
    'SBSO_TST'  'ROUND(SBSO.TSTper*100, 1) AS SBSO_TSTper'
    'WASO_ep'   'WASO.epochs AS WASOeps'
    'WASO_min'  'WASO.Minutes AS WASOmin'
    'WASO_TDT'  'ROUND(WASO.TDTper*100, 1) AS WASO_TDTper'
    'WASO_SPT'  'ROUND(WASO.SPTper*100, 1) AS WASO_SPTper'
    'WASO_TST'  'ROUND(WASO.TSTper*100, 1) AS WASO_TSTper'
    'WAFA_ep'   'WAFA.epochs AS WAFAeps'
    'WAFA_min'  'WAFA.Minutes AS WAFAmin'
    'WAFA_TDT'  'ROUND(WAFA.TDTper*100, 1) AS WAFA_TDTper'
    'WAFA_SPT'  'ROUND(WAFA.SPTper*100, 1) AS WAFA_SPTper'
    'WAFA_TST'  'ROUND(WAFA.TSTper*100, 1) AS WAFA_TSTper'
    'SAFA_ep'   'SAFA.epochs AS SAFAeps'
    'SAFA_min'  'SAFA.Minutes AS SAFAmin'
    'SAFA_TDT'  'ROUND(SAFA.TDTper*100, 1) AS SAFA_TDTper'
    'SAFA_SPT'  'ROUND(SAFA.SPTper*100, 1) AS SAFA_SPTper'
    'SAFA_TST'  'ROUND(SAFA.TSTper*100, 1) AS SAFA_TSTper'
    'TWT_ep'   'TWT.epochs AS TWTeps'
    'TWT_min'  'TWT.Minutes AS TWTmin'
    'TWT_TDT'  'ROUND(TWT.TDTper*100, 1) AS TWT_TDTper'
    'TWT_SPT'  'ROUND(TWT.SPTper*100, 1) AS TWT_SPTper'
    'TWT_TST'  'ROUND(TWT.TSTper*100, 1) AS TWT_TSTper'
    'St1_ep'   'Stage1.epochs AS St1eps'
    'St1_min'  'Stage1.Minutes AS St1min'
    'St1_TDT'  'ROUND(Stage1.TDTper*100, 1) AS St1_TDTper'
    'St1_SPT'  'ROUND(Stage1.SPTper*100, 1) AS St1_SPTper'
    'St1_TST'  'ROUND(Stage1.TSTper*100, 1) AS St1_TSTper'
    'St2_ep'   'Stage2.epochs AS St2eps'
    'St2_min'  'Stage2.Minutes AS S21min'
    'St2_TDT'  'ROUND(Stage2.TDTper*100, 1) AS St2_TDTper'
    'St2_SPT'  'ROUND(Stage2.SPTper*100, 1) AS St2_SPTper'
    'St2_TST'  'ROUND(Stage2.TSTper*100, 1) AS St2_TSTper'
    'St3_ep'   'Stage3.epochs AS St3eps'
    'St3_min'  'Stage3.Minutes AS St3min'
    'St3_TDT'  'ROUND(Stage3.TDTper*100, 1) AS St3_TDTper'
    'St3_SPT'  'ROUND(Stage3.SPTper*100, 1) AS St3_SPTper'
    'St3_TST'  'ROUND(Stage3.TSTper*100, 1) AS St3_TSTper'
    'St4_ep'   'Stage4.epochs AS St4eps'
    'St4_min'  'Stage4.Minutes AS St4min'
    'St4_TDT'  'ROUND(Stage4.TDTper*100, 1) AS St4_TDTper'
    'St4_SPT'  'ROUND(Stage4.SPTper*100, 1) AS St4_SPTper'
    'St4_TST'  'ROUND(Stage4.TSTper*100, 1) AS St4_TSTper'
    'REM_ep'   'REM.epochs AS REMeps'
    'REM_min'  'REM.Minutes AS REMmin'
    'REM_TDT'  'ROUND(REM.TDTper*100, 1) AS REM_TDTper'
    'REM_SPT'  'ROUND(REM.SPTper*100, 1) AS REM_SPTper'
    'REM_TST'  'ROUND(REM.TSTper*100, 1) AS REM_TSTper'
    'MT_ep'   'MT.epochs AS MTeps'
    'MT_min'  'MT.Minutes AS MTmin'
    'MT_TDT'  'ROUND(MT.TDTper*100, 1) AS MT_TDTper'
    'MT_SPT'  'ROUND(MT.SPTper*100, 1) AS MT_SPTper'
    'MT_TST'  'ROUND(MT.TSTper*100, 1) AS MT_TSTper'
    'NREM_ep'   'NREM.epochs AS NREMeps'
    'NREM_min'  'NREM.Minutes AS NREMmin'
    'NREM_TDT'  'ROUND(NREM.TDTper*100, 1) AS NREM_TDTper'
    'NREM_SPT'  'ROUND(NREM.SPTper*100, 1) AS NREM_SPTper'
    'NREM_TST'  'ROUND(NREM.TSTper*100, 1) AS NREM_TSTper'
    'SW_ep'   'SW.epochs AS SWeps'
    'SW_min'  'SW.Minutes AS SWmin'
    'SW_TDT'  'ROUND(SW.TDTper*100, 1) AS SW_TDTper'
    'SW_SPT'  'ROUND(SW.SPTper*100, 1) AS SW_SPTper'
    'SW_TST'  'ROUND(SW.TSTper*100, 1) AS SW_TSTper'
    'ANOM_ep'   'ANOM.epochs AS ANOMeps'
    'ANOM_min'  'ANOM.Minutes AS ANOMmin'
    'ANOM_TDT'  'ROUND(ANOM.TDTper*100, 1) AS ANOM_TDTper'
    'ANOM_SPT'  'ROUND(ANOM.SPTper*100, 1) AS ANOM_SPTper'
    'ANOM_TST'  'ROUND(ANOM.TSTper*100, 1) AS ANOM_TSTper'
    'LOSO_ep'   'latencySleep.epochs AS SleepLatency_eps'
    'LOSO_min'  'latencySleep.Minutes AS SleepLatency'
    'LO10_ep'   'latency10Min.epochs AS Lat10Min_eps'
    'LO10_min'  'latency10Min.Minutes AS Lat10Min_min'
    'LOS1_ep'   'latencyLOS1.epochs AS LatLOS1_eps'
    'LOS1_min'  'latencyLOS1.Minutes AS LatLOS1_min'
      'LOS2_ep'   'latencyLOS2.epochs AS LatLOS2_eps'
    'LOS2_min'  'latencyLOS2.Minutes AS LatLOS2_min'
      'LOS3_ep'   'latencyLOS3.epochs AS LatLOS3_eps'
    'LOS3_min'  'latencyLOS3.Minutes AS LatLOS3_min'
      'LOS4_ep'   'latencyLOS4.epochs AS LatLOS4_eps'
    'LOS4_min'  'latencyLOS4.Minutes AS LatLOS4_min'
      'LOSW_ep'   'latencyLOSW.epochs AS LatLOSW_eps'
    'LOSW_min'  'latencyLOSW.Minutes AS LatLOSW_min'
      'LOREM_ep'   'latencyLOREM.epochs AS LatLOREM_eps'
    'LOREM_min'  'latencyLOREM.Minutes AS LatLOREM_min'
      'SOS1_ep'   'latencySOS1.epochs AS LatSOS1_eps'
    'SOS1_min'  'latencySOS1.Minutes AS LatSOS1_min'
      'SOS2_ep'   'latencySOS2.epochs AS LatSOS2_eps'
    'SOS2_min'  'latencySOS2.Minutes AS LatSOS2_min'
      'SOS3_ep'   'latencySOS3.epochs AS LatSOS3_eps'
    'SOS3_min'  'latencySOS3.Minutes AS LatSOS3_min'
      'SOS4_ep'   'latencySOS4.epochs AS LatSOS4_eps'
    'SOS4_min'  'latencySOS4.Minutes AS LatSOS4_min'
      'SOSW_ep'   'latencySOSW.epochs AS LatSOSW_eps'
    'SOSW_min'  'latencySOSW.Minutes AS LatSOSW_min'
      'SOREM_ep'   'latencySOREM.epochs AS REML_eps'
    'SOREM_min'  'latencySOREM.Minutes AS REML'};

command = ['[statistics] =  fetch(getappdata(0,''Conn''), [''SELECT '',' ...
            ''', db, ''idStudy.id, '',' ...
            ''', db, ''idStudy.study, '',' ...
            ''', db, ''EDFInfo.EDFname, '',' ...
        ...
        for i = 1:size(guiDB,1)
            sw = eval(['handles.', guiDB{i,1},'.Value']);
            switch sw
                case 0
                case 1
                    command = [command ...
