function varargout = hume(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @hume_OpeningFcn, ...
    'gui_OutputFcn',  @hume_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before hume is made visible.
function hume_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to hume (see VARARGIN)
...
% Choose default command line output for hume
...
% UIWAIT makes hume wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = hume_OutputFcn(hObject, eventdata, handles)
...
set(handles.axes2, 'ButtonDownFcn', 'hume(''axes2_ButtonDownFcn'',gcbo,[],guidata(gcbo))')
...
sleepStats_woInput(handles.stageData, get(handles.stageFileIN, {'String'}));
