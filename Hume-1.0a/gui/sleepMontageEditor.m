...
% Last Modified by GUIDE v2.5 15-Jan-2015 14:17:23
...
handles.montage.hideChs = hideChs;
handles.montage.electrode = electrodes;
handles.montage.colors = colors;
handles.montage.scale = scale;
